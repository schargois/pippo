...
# test_on_env(reach_test_vec_env, model)
...
# model = next_model(model, reach_vec_env)
# # model = next_model(model, env)
...
# env_test = mt1_pick_place.train_classes["pick-place-v2"]()
# task_pick_place_test = random.choice(mt1_pick_place.train_tasks)
# env_test.set_task(task_pick_place_test)
# task_pick_place_goal = np.random.uniform(low=[-0.2, 0.4, 0.05], high=[0.2, 0.8, 0.3])
# env_test._target_pos = task_pick_place_goal
# env_test.goal = task_pick_place_goal
...
# env_test.close()
# print("Pick Place Total reward:", total_reward)

# ########################################
# ########## First Tier Testing ##########
# ########################################

# env_test = mt1_reach.train_classes["reach-v2"]()
# env_test.set_task(task_reach_test)
# env_test._target_pos = task_reach_goal
# env_test.goal = task_reach_goal
...
# env_test.close()
# print("Reach Total reward:", total_reward)
...
# ######### Third Tier Testing ###############
# ############################################
# env_test = mt1_hammer.train_classes["hammer-v2"]()
# task_hammer_test = random.choice(mt1_hammer.train_tasks)
# env_test.set_task(task_hammer_test)
# task_hammer_goal = np.random.uniform(low=[-0.2, 0.4, 0.05], high=[0.2, 0.8, 0.3])
# env_test._target_pos = task_hammer_goal
# env_test.goal = task_hammer_goal
# obs, _ = env_test.reset()
...
#     total_reward += reward
# env_test.close()
# print("Hammer Total reward:", total_reward)
...
# #     total_reward += reward[0]  # reward is a list/array now
...
# # for i in range(policy_model.numCols):
# #     column = policy_model.getColumn(i)
# #     print(f"Is {i} frozen? {column.isFrozen}")
# #     policy_columns_lst.append(column)
# # for i in range(value_model.numCols):
# #     column = value_model.getColumn(i)
# #     print(f"Is {i} frozen? {column.isFrozen}")
...
# # model = PPO(CustomActorCriticPolicy, "CartPole-v1", verbose=1, policy_kwargs={"policy_columns": policy_columns_lst, "value_columns": value_columns_lst})
# # model.learn(10000)
